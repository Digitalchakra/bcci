  ...
  $('.pname').click(function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        html+=                      '<td class="clbl3 ipl-statout-down"><p>'+data.resultset.data[0].b+'</p>';
        html+=                        '<h4>BALLS</h4></td>';
        html+=                    '</tr>';
        html+=                    '<tr WIDTH="100%">';
        ...
        html+=                        '<h4>MAID</h4></td>';
        html+=                      '<td class="clbl3"><p>'+data.resultset.data[0].nb+'</p>';
        html+=                        '<h4>NB</h4></td>';
        html+=                      '<td class="clbl3"><p>'+data.resultset.data[0].sr+'</p>';
        html+=                        '<h4>SR</h4></td>';
        html+=                    '</tr>';
        html+=                  '</table>';
        html+=                '</div>';
