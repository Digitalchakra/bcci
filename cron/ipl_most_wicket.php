...
class Ipl_most_wickets extends ActiveRecord\Model { }
$log_title = "IPL MOST WICKET CRON ";
try
	{
		...
		if(count($data_list)>0)
		{
			...
			Ipl_most_wickets::connection()->query('TRUNCATE TABLE `ipl_most_wickets`');
			foreach($data_list as $row)
			{
						Ipl_most_wickets::create($row);
			}
		}
	}
	catch (Exception $e)
