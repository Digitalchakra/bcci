...
class Ipl_most_sixes extends ActiveRecord\Model { }
$log_title = "IPL MOST SIX CRON ";
try
	{
		...
		$json_output=array();
		$data_list=array();
		$jsonurl = "http://dynamic.pulselive.com/dynamic/data/core/cricket/2012/ipl2013/stats/player/full/mostSixes.js?_".time();
		...
		if(count($data_list)>0)
		{
			...
			Ipl_most_sixes::connection()->query('TRUNCATE TABLE `ipl_most_sixes`');
			foreach($data_list as $row)
			{
						Ipl_most_sixes::create($row);
			}
		}
	}
	catch (Exception $e)
