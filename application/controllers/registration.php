		  ...
		  else
		  {
			...
			if(!$this->user_forum->check_user($check_data))
			{
				if($userID=user_add($user_row))
				{
					...
					<br><br>
					Please click on the one-time activation link below to verify your email.  <br><br><a href="'.base_url('registration/activation/'.$userID.'/'.$randStr).'">Confirm my account now</a>
					<br><br>
